...
* **Obtanium-Compatible Releases:** Each publication gets a unique semver release tag, while GitHub's latest release continues to contain the complete current APK set.
